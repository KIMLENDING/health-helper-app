...
import { useAExerciseSession, useActionExerciseSession } from '@/server/mutations';
...
const Page = () => {
    ...
    const useStateChangeExerciseSessionMutation = useActionExerciseSession(); // 선택한 운동 상태 변경 후 운동 시작 mutation
    const useAllDoneExerciseSessionMutation = useAExerciseSession(); // 모든 운동 완료 mutation
