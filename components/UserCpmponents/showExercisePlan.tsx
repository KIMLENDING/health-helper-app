        ...
        {[1, 2, 3].map((i) => (
            <Card key={i} className="overflow-hidden border-0 shadow-md">
                <div className="flex p-6">
                    <div className="w-12 h-12 rounded-full bg-zinc-200 dark:bg-zinc-700 animate-pulse mr-4" />
                    <div className="flex-1">
                        <div className="h-5 bg-zinc-200 dark:bg-zinc-700 animate-pulse rounded w-3/4 mb-2" />
                        <div className="h-4 bg-zinc-100 dark:bg-zinc-800 animate-pulse rounded w-1/2" />
                    </div>
                </div>
            </Card>
        ))}
    ...
    return (
        <div className="mx-auto w-full max-w-4xl py-4 min-h-[calc(100vh-56px)] relative flex flex-col gap-4">
            ...
            <AsyncStateWrapper
                ...
                data={data}
                loadingSkeleton={<PlanListSkeleton />}
                emptyState={
                    <EmptyState
                        action={{
